<?php 
 $GLOBALS["dictionary"]["Account"]=array (
  ...
  array (
    ...
    array (
      'inline_edit' => '',
      'labelValue' => 'contact user id',
      'required' => false,
      'source' => 'non-db',
      'name' => 'contact_user_id_c',
      'vname' => 'LBL_CONTACT_USER_ID',
      'type' => 'relate',
      'massupdate' => '0',
      'default' => NULL,
      'no_default' => false,
    ...
    array (
      ...
      'name' => 'contact_id1_c',
      'vname' => 'LBL_MAIN_CONTACT_ID_CONTACT_ID',
      'type' => 'id',
      'massupdate' => '0',
      'default' => NULL,
      'no_default' => false,
    ...
    array (
      ...
      'source' => 'custom_fields',
      'name' => 'contact_id_c',
      'vname' => 'LBL_CONTACT_USER_ID_CONTACT_ID',
      'type' => 'id',
      'massupdate' => '0',
      'default' => NULL,
      'no_default' => false,
    ...
    array (
      'inline_edit' => '1',
      'labelValue' => 'Main Contact ID',
      'required' => false,
      'source' => 'non-db',
      'name' => 'main_contact_id_c',
