...
addToValidate('form_QuickCreate_Accounts', 'custom_mobile', 'varchar', false,'{/literal}{sugar_translate label='LBL_CUSTOM_MOBILE' module='Accounts' for_js=true}{literal}' );
