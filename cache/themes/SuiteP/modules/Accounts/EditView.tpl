...
{if strlen($fields.custom_mobile_.value) <= 0}
{assign var="value" value=$fields.custom_mobile_.default_value }
{else}
{assign var="value" value=$fields.custom_mobile_.value }
{/if}  
<input type='text' name='{$fields.custom_mobile_.name}' 
id='{$fields.custom_mobile_.name}' size='30' 
maxlength='510' 
value='{$value}' title=''      >
</div>
...
{/literal}{literal}
<script type="text/javascript">
addForm('EditView');addToValidate('EditView', 'custom_mobile_', 'varchar', false,'{/literal}{sugar_translate label='LBL_CUSTOM_MOBILE' module='Accounts' for_js=true}{literal}' );
