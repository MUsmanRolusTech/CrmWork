...
<input type='text' name='{$fields.email_advanced.name}' 
    ...
    value='{$value}' title=''      >
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='custom_identity_advanced'>{sugar_translate label='LBL_CUSTOM_IDENTITY' module='Contacts'}</label>
                            </div>
            <div class="form-item">
...
{if strval($fields.custom_identity_advanced.value) == "1"}
	{assign var="yes" value="SELECTED"}
{elseif strval($fields.custom_identity_advanced.value) == "0"}
	{assign var="no" value="SELECTED"}
{else}
	{assign var="default" value="SELECTED"}
{/if}

<select id="{$fields.custom_identity_advanced.name}" name="{$fields.custom_identity_advanced.name}"   >
 ...
 <option value = "1" {$yes}> {$APP.LBL_SEARCH_DROPDOWN_YES}</option>
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='created_date_time_advanced'>{sugar_translate label='LBL_CREATED_DATE_TIME' module='Contacts'}</label>
                            </div>
            <div class="form-item">
                                
{assign var="id" value=$fields.created_date_time_advanced.name }

{if isset($smarty.request.created_date_time_advanced_range_choice)}
{assign var="starting_choice" value=$smarty.request.created_date_time_advanced_range_choice}
{else}
...
{html_options options=$fields.created_date_time_advanced.options selected=$starting_choice}
</select>
</div>

<div id="{$id}_range_div" style="{if preg_match('/^\[/', $smarty.request.range_created_date_time_advanced)  || $starting_choice == 'between'}display:none{else}display:''{/if};">
<input autocomplete="off" type="text" name="range_{$id}" id="range_{$id}" value='{if empty($smarty.request.range_created_date_time_advanced) && !empty($smarty.request.created_date_time_advanced)}{$smarty.request.created_date_time_advanced}{else}{$smarty.request.range_created_date_time_advanced}{/if}' title=''   size="11" class="dateRangeInput">
...
{assign var=date_value value=$fields.created_date_time_advanced.value }
<input autocomplete="off" type="text" name="start_range_{$id}" id="start_range_{$id}" value='{$smarty.request.start_range_created_date_time_advanced }' title=''  tabindex='' size="11" class="dateRangeInput">
...
{$APP.LBL_AND}
{assign var=date_value value=$fields.created_date_time_advanced.value }
<input autocomplete="off" type="text" name="end_range_{$id}" id="end_range_{$id}" value='{$smarty.request.end_range_created_date_time_advanced }' title=''  tabindex='' size="11" class="dateRangeInput" maxlength="10">
...
{rdelim}
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='custom_contact_status_advanced'>{sugar_translate label='LBL_CUSTOM_CONTACT_STATUS' module='Contacts'}</label>
                            </div>
            <div class="form-item">
                                
{html_options id='custom_contact_status_advanced' name='custom_contact_status_advanced[]' options=$fields.custom_contact_status_advanced.options size="6" class="templateGroupChooser" multiple="1" selected=$fields.custom_contact_status_advanced.value}
                            </div>
        </div>
    </div>
        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 col-advanced-search">
