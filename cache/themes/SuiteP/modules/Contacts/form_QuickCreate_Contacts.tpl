...
addToValidate('form_QuickCreate_Contacts', 'custom_phone_no', 'varchar', false,'{/literal}{sugar_translate label='LBL_CUSTOM_PHONE_NO' module='Contacts' for_js=true}{literal}' );
