...
{if !$fields.custom_phone_no.hidden}
{counter name="panelFieldCount" print=false}
...
{/if} 
<span class="sugar_field" id="{$fields.custom_phone_no.name}">{$fields.custom_phone_no.value}</span>
{/if}
...
{if !$fields.created_date_time.hidden}
{counter name="panelFieldCount" print=false}
...
{else}
{if strlen($fields.created_date_time.value) <= 0}
{assign var="value" value=$fields.created_date_time.default_value }
{else}
{assign var="value" value=$fields.created_date_time.value }
{/if}
{/if}
<span class="sugar_field" id="{$fields.created_date_time.name}">{$value}</span>
{/if}
...
{if !$fields.custom_identity.hidden}
{counter name="panelFieldCount" print=false}

<span class="sugar_field" id="{$fields.custom_identity.name}">
{sugar_number_format precision=0 var=$fields.custom_identity.value}
</span>
{/if}
...
{if !$fields.custom_contact_status.hidden}
{counter name="panelFieldCount" print=false}


{if is_string($fields.custom_contact_status.options)}
<input type="hidden" class="sugar_field" id="{$fields.custom_contact_status.name}" value="{ $fields.custom_contact_status.options }">
{ $fields.custom_contact_status.options }
{else}
<input type="hidden" class="sugar_field" id="{$fields.custom_contact_status.name}" value="{ $fields.custom_contact_status.value }">
{ $fields.custom_contact_status.options[$fields.custom_contact_status.value]}
{/if}
{/if}
