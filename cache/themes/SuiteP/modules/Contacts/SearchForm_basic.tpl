...
value="1" title='' tabindex="" {$checked} >
	...
	<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 search_fields_basic">
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-4">
						<label for='custom_identity_basic' >{sugar_translate label='LBL_CUSTOM_IDENTITY' module='Contacts'}</label>
					</div>
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-8">
...
{if strval($fields.custom_identity_basic.value) == "1"}
	{assign var="yes" value="SELECTED"}
{elseif strval($fields.custom_identity_basic.value) == "0"}
	{assign var="no" value="SELECTED"}
{else}
	{assign var="default" value="SELECTED"}
{/if}

<select id="{$fields.custom_identity_basic.name}" name="{$fields.custom_identity_basic.name}"   >
 ...
 <option value = "1" {$yes}> {$APP.LBL_SEARCH_DROPDOWN_YES}</option>
	...
	<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 search_fields_basic">
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-4">
						<label for='custom_contact_status_basic' >{sugar_translate label='LBL_CUSTOM_CONTACT_STATUS' module='Contacts'}</label>
					</div>
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-8">
		
{html_options id='custom_contact_status_basic' name='custom_contact_status_basic[]' options=$fields.custom_contact_status_basic.options size="6" class="templateGroupChooser" multiple="1" selected=$fields.custom_contact_status_basic.value}
		</div>
		<div class="search-clear"></div>
	</div>
</div>
