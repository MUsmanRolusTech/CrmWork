...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_IDENTITY' module='Contacts'}{/capture}
{$label|strip_semicolon}:
...
{if strlen($fields.identity.value) <= 0}
{assign var="value" value=$fields.identity.default_value }
{else}
{assign var="value" value=$fields.identity.value }
{/if}  
<input type='text' name='{$fields.identity.name}' 
id='{$fields.identity.name}' size='30'  value='{sugar_number_format precision=0 var=$value}' title='' tabindex='0'    >
</div>
...
addToValidate('EditView', 'identity', 'int', false,'{/literal}{sugar_translate label='LBL_IDENTITY' module='Contacts' for_js=true}{literal}' );
