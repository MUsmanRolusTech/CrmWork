...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_CUSTOM_PHONE_NO' module='Contacts'}{/capture}
{$label|strip_semicolon}:
...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_CREATED_DATE_TIME' module='Contacts'}{/capture}
{$label|strip_semicolon}:
...
<span class="dateTime">
{assign var=date_value value=$fields.created_date_time.value }
<input class="date_input" autocomplete="off" type="text" name="{$fields.created_date_time.name}" id="{$fields.created_date_time.name}" value="{$date_value}" title=''  tabindex='0'    size="11" maxlength="10" >
<button type="button" id="{$fields.created_date_time.name}_trigger" class="btn btn-danger" onclick="return false;"><span class="suitepicon suitepicon-module-calendar" alt="{$APP.LBL_ENTER_DATE}"></span></button>
</span>
<script type="text/javascript">
Calendar.setup ({ldelim}
inputField : "{$fields.created_date_time.name}",
form : "EditView",
ifFormat : "{$CALENDAR_FORMAT}",
daFormat : "{$CALENDAR_FORMAT}",
button : "{$fields.created_date_time.name}_trigger",
singleClick : true,
dateStr : "{$date_value}",
...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_CUSTOM_IDENTITY' module='Contacts'}{/capture}
{$label|strip_semicolon}:
...
{if strlen($fields.custom_identity.value) <= 0}
{assign var="value" value=$fields.custom_identity.default_value }
{else}
{assign var="value" value=$fields.custom_identity.value }
{/if}  
<input type='text' name='{$fields.custom_identity.name}' 
id='{$fields.custom_identity.name}' size='30'  value='{sugar_number_format precision=0 var=$value}' title='' tabindex='0'    >
</div>
...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_CUSTOM_CONTACT_STATUS' module='Contacts'}{/capture}
{$label|strip_semicolon}:
...
<select name="{$fields.custom_contact_status.name}"
id="{$fields.custom_contact_status.name}"
title=''          
>
{if isset($fields.custom_contact_status.value) && $fields.custom_contact_status.value != ''}
{html_options options=$fields.custom_contact_status.options selected=$fields.custom_contact_status.value}
{else}
{html_options options=$fields.custom_contact_status.options selected=$fields.custom_contact_status.default}
{/if}
</select>
</div>
...
addToValidate('EditView', 'custom_phone_no', 'varchar', false,'{/literal}{sugar_translate label='LBL_CUSTOM_PHONE_NO' module='Contacts' for_js=true}{literal}' );
addToValidate('EditView', 'created_date_time_date', 'date', false,'Created at' );
addToValidate('EditView', 'custom_identity', 'int', false,'{/literal}{sugar_translate label='LBL_CUSTOM_IDENTITY' module='Contacts' for_js=true}{literal}' );
addToValidate('EditView', 'custom_contact_status', 'enum', false,'{/literal}{sugar_translate label='LBL_CUSTOM_CONTACT_STATUS' module='Contacts' for_js=true}{literal}' );
