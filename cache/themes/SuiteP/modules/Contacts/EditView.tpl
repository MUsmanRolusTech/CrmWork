...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_CUSTOM_EMAIL' module='Contacts'}{/capture}
{$label|strip_semicolon}:
...
{if strlen($fields.custom_email_.value) <= 0}
{assign var="value" value=$fields.custom_email_.default_value }
{else}
{assign var="value" value=$fields.custom_email_.value }
{/if}  
<input type='text' name='{$fields.custom_email_.name}' 
id='{$fields.custom_email_.name}' size='30' 
maxlength='510' 
value='{$value}' title=''      >
</div>
