<?php /* Smarty version 2.6.33, created on 2022-05-10 15:14:16
         compiled from cache/themes/SuiteP/modules/Contacts/DetailView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_include', 'cache/themes/SuiteP/modules/Contacts/DetailView.tpl', 46, false),array('function', 'sugar_translate', 'cache/themes/SuiteP/modules/Contacts/DetailView.tpl', 55, false),array('function', 'counter', 'cache/themes/SuiteP/modules/Contacts/DetailView.tpl', 143, false),array('function', 'sugar_phone', 'cache/themes/SuiteP/modules/Contacts/DetailView.tpl', 221, false),array('function', 'sugar_ajax_url', 'cache/themes/SuiteP/modules/Contacts/DetailView.tpl', 400, false),array('function', 'sugar_number_format', 'cache/themes/SuiteP/modules/Contacts/DetailView.tpl', 541, false),array('modifier', 'strip_semicolon', 'cache/themes/SuiteP/modules/Contacts/DetailView.tpl', 136, false),array('modifier', 'escape', 'cache/themes/SuiteP/modules/Contacts/DetailView.tpl', 617, false),array('modifier', 'url2html', 'cache/themes/SuiteP/modules/Contacts/DetailView.tpl', 617, false),array('modifier', 'nl2br', 'cache/themes/SuiteP/modules/Contacts/DetailView.tpl', 617, false),array('modifier', 'strip_tags', 'cache/themes/SuiteP/modules/Contacts/DetailView.tpl', 628, false),)), $this); ?>
...
<div class="col-xs-12 col-sm-8 detail-view-field inlineEdit" type="varchar" field="custom_phone_no" >

<?php if (! $this->_tpl_vars['fields']['custom_phone_no']['hidden']): ?>
<?php echo smarty_function_counter(array('name' => 'panelFieldCount','print' => false), $this);?>
...
<?php endif; ?> 
<span class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['custom_phone_no']['name']; ?>
"><?php echo $this->_tpl_vars['fields']['custom_phone_no']['value']; ?>
</span>
<?php endif; ?>
...
<div class="col-xs-12 col-sm-8 detail-view-field inlineEdit" type="datetime" field="created_date_time" >

<?php if (! $this->_tpl_vars['fields']['created_date_time']['hidden']): ?>
<?php echo smarty_function_counter(array('name' => 'panelFieldCount','print' => false), $this);?>
...
<?php else: ?>
<?php if (strlen ( $this->_tpl_vars['fields']['created_date_time']['value'] ) <= 0): ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['created_date_time']['default_value']); ?>
<?php else: ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['created_date_time']['value']); ?>
<?php endif; ?>
<?php endif; ?>
<span class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['created_date_time']['name']; ?>
...
<div class="col-xs-12 col-sm-8 detail-view-field inlineEdit" type="int" field="custom_identity" >

<?php if (! $this->_tpl_vars['fields']['custom_identity']['hidden']): ?>
<?php echo smarty_function_counter(array('name' => 'panelFieldCount','print' => false), $this);?>


<span class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['custom_identity']['name']; ?>
">
<?php echo smarty_function_sugar_number_format(array('precision' => 0,'var' => $this->_tpl_vars['fields']['custom_identity']['value']), $this);?>
...
<div class="col-xs-12 col-sm-8 detail-view-field inlineEdit" type="enum" field="custom_contact_status" >

<?php if (! $this->_tpl_vars['fields']['custom_contact_status']['hidden']): ?>
<?php echo smarty_function_counter(array('name' => 'panelFieldCount','print' => false), $this);?>



<?php if (is_string ( $this->_tpl_vars['fields']['custom_contact_status']['options'] )): ?>
<input type="hidden" class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['custom_contact_status']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['custom_contact_status']['options']; ?>
">
<?php echo $this->_tpl_vars['fields']['custom_contact_status']['options']; ?>

<?php else: ?>
<input type="hidden" class="sugar_field" id="<?php echo $this->_tpl_vars['fields']['custom_contact_status']['name']; ?>
" value="<?php echo $this->_tpl_vars['fields']['custom_contact_status']['value']; ?>
">
<?php echo $this->_tpl_vars['fields']['custom_contact_status']['options'][$this->_tpl_vars['fields']['custom_contact_status']['value']]; ?>
