<?php /* Smarty version 2.6.33, created on 2022-05-10 14:40:20
         compiled from cache/themes/SuiteP/modules/Contacts/SearchForm_basic.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/themes/SuiteP/modules/Contacts/SearchForm_basic.tpl', 31, false),array('function', 'math', 'cache/themes/SuiteP/modules/Contacts/SearchForm_basic.tpl', 32, false),array('function', 'sugar_translate', 'cache/themes/SuiteP/modules/Contacts/SearchForm_basic.tpl', 38, false),array('function', 'html_options', 'cache/themes/SuiteP/modules/Contacts/SearchForm_basic.tpl', 151, false),array('function', 'sugar_getimagepath', 'cache/themes/SuiteP/modules/Contacts/SearchForm_basic.tpl', 165, false),)), $this); ?>
...
value="1" title='' tabindex="" <?php echo $this->_tpl_vars['checked']; ?>
 >
	...
	<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 search_fields_basic">
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-4">
						<label for='custom_identity_basic' ><?php echo smarty_function_sugar_translate(array('label' => 'LBL_CUSTOM_IDENTITY','module' => 'Contacts'), $this);?>
</label>
					</div>
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-8">
...
<?php if (strval ( $this->_tpl_vars['fields']['custom_identity_basic']['value'] ) == '1'): ?>
	<?php $this->assign('yes', 'SELECTED'); ?>
<?php elseif (strval ( $this->_tpl_vars['fields']['custom_identity_basic']['value'] ) == '0'): ?>
	<?php $this->assign('no', 'SELECTED'); ?>
<?php else: ?>
	<?php $this->assign('default', 'SELECTED'); ?>
<?php endif; ?>

<select id="<?php echo $this->_tpl_vars['fields']['custom_identity_basic']['name']; ?>
" name="<?php echo $this->_tpl_vars['fields']['custom_identity_basic']['name']; ?>
"   >
...
> <?php echo $this->_tpl_vars['APP']['LBL_SEARCH_DROPDOWN_YES']; ?>
	...
	<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 search_fields_basic">
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-4">
						<label for='custom_contact_status_basic' ><?php echo smarty_function_sugar_translate(array('label' => 'LBL_CUSTOM_CONTACT_STATUS','module' => 'Contacts'), $this);?>
</label>
					</div>
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-8">
		
<?php echo smarty_function_html_options(array('id' => 'custom_contact_status_basic','name' => 'custom_contact_status_basic[]','options' => $this->_tpl_vars['fields']['custom_contact_status_basic']['options'],'size' => '6','class' => 'templateGroupChooser','multiple' => '1','selected' => $this->_tpl_vars['fields']['custom_contact_status_basic']['value']), $this);?>
