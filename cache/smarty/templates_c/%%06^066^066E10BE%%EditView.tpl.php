<?php /* Smarty version 2.6.33, created on 2022-05-09 18:56:57
...
<div class="col-xs-12 col-sm-4 label" data-label="LBL_IDENTITY">

<?php $this->_tag_stack[] = array('minify', array()); $_block_repeat=true;smarty_block_minify($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_IDENTITY','module' => 'Contacts'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
...
<div class="col-xs-12 col-sm-8 edit-view-field " type="int" field="identity"  >
<?php echo smarty_function_counter(array('name' => 'panelFieldCount','print' => false), $this);?>


<?php if (strlen ( $this->_tpl_vars['fields']['identity']['value'] ) <= 0): ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['identity']['default_value']); ?>
<?php else: ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['identity']['value']); ?>
<?php endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['identity']['name']; ?>
' 
id='<?php echo $this->_tpl_vars['fields']['identity']['name']; ?>
...
addToValidate(\'EditView\', \'identity\', \'int\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_IDENTITY','module' => 'Contacts','for_js' => true), $this);?>
<?php echo '\' );
