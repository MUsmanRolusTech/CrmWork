...
' title=''      >
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='custom_identity_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_CUSTOM_IDENTITY','module' => 'Contacts'), $this);?>
</label>
                            </div>
            <div class="form-item">
...
<?php if (strval ( $this->_tpl_vars['fields']['custom_identity_advanced']['value'] ) == '1'): ?>
	<?php $this->assign('yes', 'SELECTED'); ?>
<?php elseif (strval ( $this->_tpl_vars['fields']['custom_identity_advanced']['value'] ) == '0'): ?>
	<?php $this->assign('no', 'SELECTED'); ?>
<?php else: ?>
	<?php $this->assign('default', 'SELECTED'); ?>
<?php endif; ?>

<select id="<?php echo $this->_tpl_vars['fields']['custom_identity_advanced']['name']; ?>
" name="<?php echo $this->_tpl_vars['fields']['custom_identity_advanced']['name']; ?>
"   >
...
> <?php echo $this->_tpl_vars['APP']['LBL_SEARCH_DROPDOWN_YES']; ?>
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='created_date_time_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_CREATED_DATE_TIME','module' => 'Contacts'), $this);?>
</label>
                            </div>
            <div class="form-item">
                                
<?php $this->assign('id', $this->_tpl_vars['fields']['created_date_time_advanced']['name']); ?>

<?php if (isset ( $_REQUEST['created_date_time_advanced_range_choice'] )): ?>
<?php $this->assign('starting_choice', $_REQUEST['created_date_time_advanced_range_choice']); ?>
<?php else: ?>
...
<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['created_date_time_advanced']['options'],'selected' => $this->_tpl_vars['starting_choice']), $this);?>

</select>
</div>

<div id="<?php echo $this->_tpl_vars['id']; ?>
_range_div" style="<?php if (preg_match ( '/^\[/' , $_REQUEST['range_created_date_time_advanced'] ) || $this->_tpl_vars['starting_choice'] == 'between'): ?>display:none<?php else: ?>display:''<?php endif; ?>;">
<input autocomplete="off" type="text" name="range_<?php echo $this->_tpl_vars['id']; ?>
" id="range_<?php echo $this->_tpl_vars['id']; ?>
" value='<?php if (empty ( $_REQUEST['range_created_date_time_advanced'] ) && ! empty ( $_REQUEST['created_date_time_advanced'] )): ?><?php echo $_REQUEST['created_date_time_advanced']; ?>
<?php else: ?><?php echo $_REQUEST['range_created_date_time_advanced']; ?>
...
<?php $this->assign('date_value', $this->_tpl_vars['fields']['created_date_time_advanced']['value']); ?>
<input autocomplete="off" type="text" name="start_range_<?php echo $this->_tpl_vars['id']; ?>
" id="start_range_<?php echo $this->_tpl_vars['id']; ?>
" value='<?php echo $_REQUEST['start_range_created_date_time_advanced']; ?>
...
" value='<?php echo $_REQUEST['end_range_created_date_time_advanced']; ?>
...
").focus();
        ...
        <div class="">
            ...
            <div class="col-xs-12">
                                <label for='custom_contact_status_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_CUSTOM_CONTACT_STATUS','module' => 'Contacts'), $this);?>
</label>
                            </div>
            <div class="form-item">
                                
<?php echo smarty_function_html_options(array('id' => 'custom_contact_status_advanced','name' => 'custom_contact_status_advanced[]','options' => $this->_tpl_vars['fields']['custom_contact_status_advanced']['options'],'size' => '6','class' => 'templateGroupChooser','multiple' => '1','selected' => $this->_tpl_vars['fields']['custom_contact_status_advanced']['value']), $this);?>
