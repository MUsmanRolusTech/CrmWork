<?php /* Smarty version 2.6.33, created on 2022-05-09 15:00:06
         compiled from modules/AM_ProjectTemplates/tpls/footer.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'sugar_button', 'modules/AM_ProjectTemplates/tpls/footer.tpl', 123, false),)), $this); ?>
{*
/**
 *
...
<?php if (! empty ( $this->_tpl_vars['form'] ) && ! empty ( $this->_tpl_vars['form']['buttons_footer'] )): ?>
   <?php $_from = $this->_tpl_vars['form']['buttons_footer']; if (($_from instanceof StdClass) || (!is_array($_from) && !is_object($_from))) { settype($_from, 'array'); }if (count($_from)):
